...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        ...
        <asp:Panel ID="PanelManInfo" runat="server">
            <table style="width: 333px">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtFname" runat="server" Width="127px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>Email:</td>
                    <td>
                        <asp:TextBox ID="txt1Email" runat="server" style="margin-left: 6px" Width="182px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>Street:</td>
    ...
    <asp:Panel ID="Panel6" runat="server" Height="545px" Width="596px">
        <span class="auto-style1"><strong>TEST</strong></span>
        <br />
